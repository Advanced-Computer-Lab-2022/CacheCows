...
/>
      ...
      <Button
        onClick={() => window.location.href=`/CoursePagePreview?course_id=${course.course_id}&week=${1}`}
       ...
       onClick={() => window.location.href=`/Paycourse?course_name=${course.course_name}&course_price=${course.course_price}&course_id=${course._id}&inst_id=${course.instructor_id}`}
